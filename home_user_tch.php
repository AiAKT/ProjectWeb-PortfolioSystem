...
<body>
    ...
    <div class="row">
        ...
        <div class="alert alert-success" style="width:auto;">
            <strong>
                <h1 style="text-align:center;">ผลงานอาจารย์</h1>
            </strong>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-3 col-md-offset-1" class="dropdown">
            ...
            <div id="myDropdown" class="dropdown-content">
                <a href="http://localhost/project/home_user_std.php">ผลงานนิสิต</a>
                <a href="http://localhost/project/home_user_tch.php">ผลงานอาจารย์</a>
            </div> -->
        </div>
        <div class="col-md-2 ">
            <input class="form-control" type="text" id="myInput" onkeyup="myFunctionSearch()" placeholder="ค้นหา ชื่อ-นามสกุล">
        </div>
        ...
        <table id="myTable" class="table table-striped  table-responsive table-bordered">
                ...
                <tbody>
                    <?php
                            ...
                            $stmt = $conn->prepare("SELECT pdf.doc_name,pdf.doc_file,home.sname,home.position,home.fullname,home.email,home.performance
                            ,home.semester,home.yeartch, home.pername ,  SUBSTRING_INDEX(home.dateup,' ',1) AS date 
                    ...
                    <tr>
                        ...
                        <!-- <td><?= $row['doc_name'];?></td> -->
                        <td><a href="docs_tch/<?php echo $row['doc_file'];?>" target="_blank"
    ...
    <!-- <div class="row">
        ...
        <div class="col-md-4">
            <img src="/img/exam1.jpg" width="550" style="margin-top:15px;">
            <br>
            <button type="button" class="btn btn-success" style="margin-top:10px;">รายละเอียดเพิ่มเติม</button>
    ...
    <!-- <div class="row">
        <div class="col">
            <h4 style="text-align:center;">ผลงาน : เว็บ... / ปี 2565 / นางสาวปานวาด ปัดทุมแฝง คณะวิทยาศาสตร์
                สาขาวิทยาการคอมพิวเตอร์ ชั้นปีที่ 4</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4"></div>
        <div class="col-md-4">
            <img src="/img/exam2.jpg" width="550" style="margin-top:15px;">
            <br>
            <button type="button" class="btn btn-success" style="margin-top:10px;">รายละเอียดเพิ่มเติม</button>
        </div>
    </div>
    ...
    <!-- <div class="row">
        <div class="col">
            <h4 style="text-align:center;">ผลงาน : เว็บ... / ปี 2565 / นางสาวทิพชฎา พิบาลศิล คณะวิทยาศาสตร์
                สาขาวิทยาการคอมพิวเตอร์ ชั้นปีที่ 4</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4"></div>
        <div class="col-md-4">
            <img src="/img/exam3.jpg" width="550" style="margin-top:15px;">
            <br>
            <button type="button" class="btn btn-success" style="margin-top:10px;">รายละเอียดเพิ่มเติม</button>
        </div>
    </div>
