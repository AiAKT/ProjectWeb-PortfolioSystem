                ...
                <div class="col-md-10"> <br>
                    ...
                    <table class="table table-striped  table-hover table-responsive table-bordered">
                        ...
                        <tbody>
                            ...
                            $stmt = $conn->prepare("SELECT * FROM `tbl_pdf` INNER JOIN tb_addstd ON tbl_pdf.fileID = tb_addstd.fileID
                            ");
                            $stmt->execute();
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Multiple Upload Image PHP</title>
</head>
<body>
  <h1>Multiple Upload Image PHP</h1>

  <h4>* jpg / jpeg / png / gif *</h1>
