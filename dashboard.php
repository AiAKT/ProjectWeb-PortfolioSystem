...
$result6 = mysqli_query($condb, $query6);
    ...
    // ********************************************************** วงกลม
$query7 = "SELECT pername, COUNT(fileID) as total FROM tb_addstd GROUP BY pername;";
$result7 = mysqli_query($condb, $query7);
 
    //นำข้อมูลที่ได้จากคิวรี่มากำหนดรูปแบบข้อมุลให้ถูกโครงสร้างของกราฟที่ใช้ *อ่าน docs เพิ่มเติม
$datax1 = array();
foreach ($result7 as $k) {
    $datax1[] = "['".$k['pername']."'".", ".$k['total']."]";
}
    ...
    <div class="row">
        ...
        <div class="col-md-2 col-md-offset-1" class="dropdown" style="margin-top: 20px;">
            ...
            <div id="myDropdown" class="dropdown-content">
                <a href="http://localhost/project/dashboard.php">จำนวนผลงานนิสิต</a>
                <a href="http://localhost/project/dashboard_tch.php">จำนวนผลงานอาจารย์</a>
            </div>
        </div>
