...
<body>
    ...
    <div class="alert alert-success" style="width:auto;">
        <strong>
            <h2 style="text-align:center;">แก้ไขหรือลบผลงานนิสิต</h2>
        </strong>
    </div>
            ...
            <table id="myTable" class="table table-striped  table-responsive table-bordered">
                ...
                <tbody>
                    <?php
                            ...
                            $stmt = $conn->prepare("SELECT pdf.doc_name,pdf.doc_file,home.ids,home.fileID,home.sname,home.fullname, home.tchname
                            ,home.years,home.email,home.performance,home.pername,home.semester,home.yearstd,  SUBSTRING_INDEX(home.dateup,' ',1) AS date 
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-warning" href="edit_formstd.php?id=<?php echo $row['fileID'];?>"> <i
                                    class="	fa fa-pencil-square"></i> </a>
                        </td>
                        <td>
                            <a class="btn btn-danger" href="delete_formstd.php?id=<?php echo $row['fileID'];?>"
